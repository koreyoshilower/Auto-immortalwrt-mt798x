...
sed -i 's/$hostname-2.4G/wifi_2.4G/g' package/mtk/drivers/wifi-profile/files/common/mt79xx/lib/wifi/mtk.sh
sed -i 's/OpenWRT-2.4G/wifi_2.4G/g' package/mtk/drivers/wifi-profile/files/common/mt79xx/lib/wifi/mtk.sh
...
sed -i 's/$hostname-5G/wifi_5G/g' package/mtk/drivers/wifi-profile/files/common/mt79xx/lib/wifi/mtk.sh
sed -i 's/OpenWRT-5G/wifi_5G/g' package/mtk/drivers/wifi-profile/files/common/mt79xx/lib/wifi/mtk.sh
